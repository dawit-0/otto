...
export const api = {
  ...
  updateRow: (dbId: string, table: string, pk: Record<string, unknown>, updates: Record<string, unknown>) =>
    request<{ row: Record<string, unknown> | null }>(`/databases/${dbId}/tables/${table}/rows`, {
      method: 'PATCH',
