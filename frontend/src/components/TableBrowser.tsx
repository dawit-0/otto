...
export default function TableBrowser({ dbId, tableName, columnDefs, foreignKeys = [], initialFilter, onFkNavigate }: Props) {
  ...
  const [filters, setFilters] = useState<FilterRule[]>(
    initialFilter
      ? [{ id: 'fk-nav-init', column: initialFilter.column, op: 'equals', value: initialFilter.value }]
      : [],
  );
