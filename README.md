...
- **Data** — Paginated table browser with column/row count display; inline cell editing, row insert/delete, and NULL toggling for tables with a usable primary key (falls back to `rowid` for SQLite tables without one)
